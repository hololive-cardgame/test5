...
const customRomajiMap = {
  ...
  "不知火": "shiranui",
  "フレア": ["furea","flare"],
  "不知火フレア": ["shiranuifurea","不知火芙蕾雅"],
  "白銀": "shirogane",
  "ノエル": ["noeru","noel"],
  "白銀ノエル": ["shiroganenoeru","白銀諾艾爾"],
  "宝鐘": "houshou",
  "マリン": "marine",
  "宝鐘マリン": "寶鐘瑪琳",
  // 4期生
  ...
  "姫森": "himemori",
  "ルーナ": ["runa","luna"],
  "姫森ルーナ": ["himemoriluna","姬森璐娜"],
  // 5期生
  "雪花": "yukihana",
  "ラミィ": "lamy",
  "雪花ラミィ": ["yukihanaramyi","雪花菈米"],
  "桃鈴": "momosuzu",
  "桃鈴ねね": "桃鈴音音",
  "獅白": "shishiro",
  "獅白ぼたん": "獅白牡丹",
  "尾丸": "omaru",
  "ポルカ": "polka",
  "尾丸ポルカ": ["omaruporuka","尾丸波爾卡"],
  // holoX
  "ラプラス": ["la+","laplus"],
  "ダークネス": ["dakunesu","darknesss"],
  "ラプラス・ダークネス": ["rapurasudakunesu","la+darknesss","laplusdarknesss","拉普拉斯暗黑","拉普拉斯達克尼斯"],
  "鷹嶺": "takane",
  "ルイ": "lui",
  "鷹嶺ルイ": ["takanerui","鷹嶺琉依"],
  "博衣": "hakui",
  ...
  "ムーナ": ["muna","moona"],
  "ホシノヴァ" : "hoshinova",
  "ムーナ・ホシノヴァ": ["munahoshinova","moonahoshinova","暮娜惑星諾瓦"],
  "イオフィフティーン": ["iofyifuthin","iofifteen"],
  "アイラニ・イオフィフティーン": ["airaniiofyifuthin","airaniiofifteen","艾拉妮伊歐菲芙婷"],
  // ID2期生
  "オリー": "ollie",
  "クレイジー・オリー": ["kureijiori","kureijiollie","克蕾西奧莉"],
  "パヴォリア": ["pavoria","pavolia"],
  "パヴォリア・レイネ": ["pavoriareine","pavoliareine","帕沃莉亞蕾內"],
  // ID3期生
  "ベスティア": ["besuthia","vestia"],
  "ゼータ": "zeta",
  "ベスティア・ゼータ": ["besuthiazeta","vestiazeta","維斯提亞澤塔"],
  "こぼ・かなえる": "可波卡娜埃露",
  // Myth
  "森": "mori",
  "カリオペ": "calliope",
  "森カリオペ": ["morikariope","森美聲"],
  "小鳥遊": "takanashi",
  "小鳥遊キアラ": "小鳥遊琪亞拉",
  "伊那尓栖": ["inanisu","ina'nis"],
  "一伊那尓栖": ["ninomaeinanisu","ninomaeina'nis","一伊那爾栖"],
  "ワトソン": "watson",
  "アメリア": "amelia",
  "ワトソン・アメリア": ["watosonameria","watsonamelia","華生阿米莉亞"],
  // Promise
  "IRyS": ["アイリス","埃莉絲"],
  "オーロ": ["oro","ouro"],
  "クロニー": "kronii",
  "オーロ・クロニー": ["ourokronii","奧羅克洛尼"],
  "七詩": "nanashi",
  "七詩ムメイ": "七詩無名",
  "ハコス": "hakos",
  "ベールズ": ["beruzu","baelz"],
  "ハコス・ベールズ": ["hakosuberuzu","hakosbaelz","哈珂斯貝爾絲"],
  // Advent
  "レイヴンクロフト": "ravencroft",
  "ネリッサ・レイヴンクロフト": ["nerissaravencroft","納瑞莎雷文克羅夫特"],
  "アビスガード": ["abisugado","abyssgard"],
  "フワワ・アビスガード": ["fuwawaabisugado","fuwawaabyssgard","軟軟阿比斯加德"],
  "モココ": "mococo",
  "モココ・アビスガード": ["mokokoabisugado","mococoabyssgard","茸茸阿比斯加德"],
  // Justice
  "ジジ": "gigi",
  "ジジ・ムリン": ["gigimurin","琪琪沐林"],
  // 事務所
  "ホロライブ": "hololive",
  "インドネシア": "indonesia",
  // 職員
